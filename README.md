...
## :Introduce
성실하고 책임감이 넘치는 신입 개발자입니다. 문제 해결에 대한 열정과 빠른 학습 능력을 바탕으로 프로젝트에 적극적으로 참여하며, 팀원들과의 원활한 협업을 중요시합니다. 백엔드와 기획에 관심이 많으며, 새로운 기술에 대한 열려있는 태도로 항상 발전하고 성장하려고 노력하고 있습니다. 
